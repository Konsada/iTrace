...
public class PCEyeMiniEyeXTracker implements IEyeTracker {
	
	private static class BackgroundThread extends Thread {
        private PCEyeMiniEyeXTracker parent = null;

        public BackgroundThread(PCEyeMiniEyeXTracker parent) {
            this.parent = parent;
        }

        public void run() {
            //TODO: Handle error condition
            jniBeginMainloop(parent);
        }

        private native boolean jniBeginMainloop(PCEyeMiniEyeXTracker parent);
    }
	...
	private static class Calibrator extends edu.ysu.itrace.Calibrator {
	     ...
	     public Calibrator(PCEyeMiniEyeXTracker tracker) throws IOException {
	    	 super();
	         parent = tracker;
	     }
    ...
    static { try{
    	System.loadLibrary("PCEyeMiniEyeXEngine");
    }
    ...
    public PCEyeMiniEyeXTracker() throws EyeTrackerConnectException,
                                 IOException {
    ...
    public static void main(String[] args) {
        PCEyeMiniEyeXTracker eyex_tracker = null;
        try {
            eyex_tracker = new PCEyeMiniEyeXTracker();
            System.out.println("Connected successfully to PCEye mini eyetracker.");
    ...
    public void newGazePoint(long timestamp, double left_x, double left_y,
        ...
        try {
            ...
            if(null == recentGazes)
            	recentGazes = new LinkedBlockingQueue<Gaze>();
